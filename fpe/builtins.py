...
isinstance_ = staticCurry(2)(flip(isinstance))
...
issubclass_ = staticCurry(2)(flip(issubclass))
...
hasattr_ = staticCurry(2)(flip(hasattr))
...
getattrRaise = staticCurry(2)(flip(getattr))
